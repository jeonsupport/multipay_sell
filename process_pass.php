<?php
    ...
    $seqno = isset($_GET['seqno']) ? $_GET['seqno'] : "";
        ...
        <div class="passBox box">
            <form method='post' action='./action/process_login.php'>
                <ul>
                    ...
                    <li>
                        <input type="password" placeholder="4자리 입력" oninput="maxLengthCheck(this)" maxlength='4' name="pw">
                    </li>
                    <li>
                        <button type="button" onclick="location.href='process.php?<?=$back_url?>'">이전</button>
